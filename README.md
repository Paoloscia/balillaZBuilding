...
- Finale e play-in NON compaiono nel tab Tornei (filtrati via notF4); `tournamentWinnerIdx` ritorna null per entrambi, quindi non contano come "tornei vinti" nei badge e nei Numeri. Badge profilo: 👑 "Campione di stagione" (da finale4 done), il vecchio 👑 rank 1 e diventato 🥇 "Regular season vinte".
